    ...
    <div class="control-container">
      ...
      <div class="control-region">
        ...
        <div class="media-control-region">
          <audio-media-control class="media-control-item" :has-more="true" :is-muted="isMicMuted"
            :audio-volume="audioVolume" @click="toggleMuteAudio"></audio-media-control>
          <video-media-control class="media-control-item" :has-more="true" :is-muted="isCameraMuted"
            @click="toggleMuteVideo"></video-media-control>
        </div>
        <div class="room-control-region">
          ...
          <div class="create-room-region">
            ...
            <div v-if="showCreateRoomItems" v-click-outside="handleClickOutsideCreateRoomItems"
              class="create-room-items">
              <div class="create-room-item" @click="createRoom('SpeakAfterTakingSeat')">
                <span :title="t('On-stage Speaking Room')" class="create-room-option">{{ t('On-stage Speaking Room')
                  }}</span>
